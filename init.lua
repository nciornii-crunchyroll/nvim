...
vim.api.nvim_set_keymap('n', '<A-w>', ':w|bd<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('i', '<A-_>', '<Plug>kommentary_line_default', {})
vim.api.nvim_set_keymap('n', '<A-_>', '<Plug>kommentary_line_default', {})
vim.api.nvim_set_keymap('v', '<A-_>', '<Plug>kommentary_visual_default', {})

-- vim-go
vim.g.go_auto_sameids = 1
vim.g.go_auto_type_info = 1
vim.g.go_build_tags = 'intgr'
